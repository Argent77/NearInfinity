...
/**
 * Implementation of opcode 148.
 */
public class Opcode148 extends BaseOpcode {
  ...
  private static final String EFFECT_SPELLPOINTNODEC_MODE    = "EEex: SpellPointNoDec() mode?";

  /** Returns the opcode name for the current game variant. */
  private static String getOpcodeName() {
    return "Cast spell at point";
  }

  public Opcode148() {
    super(148, getOpcodeName());
  }
  ...
  protected int makeEffectSpecial(Datatype parent, ByteBuffer buffer, int offset, List<StructEntry> list,
    ...
    if (Profile.isEnhancedEdition() && isEEEx() && param2 == 0) {
      list.add(new Bitmap(buffer, offset, 4, EFFECT_SPELLPOINTNODEC_MODE, AbstractStruct.OPTION_NOYES));
      return offset + 4;
    } else {
